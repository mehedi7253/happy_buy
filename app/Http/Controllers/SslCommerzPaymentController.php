...
class SslCommerzPaymentController extends Controller
{
    ...
    public function success(Request $request)
    {
        ...
        $order_detials = DB::table('orders')
            ...
            ->select('transaction_id', 'status', 'currency', 'amount', 'name', 'id', 'invoice_number')->first();
        ...
        if ($order_detials->status == 'Pending') {
            ...
            if ($validation == TRUE) {
                ...
                */
                ...
                return view('pages.payment.success', compact('tran_date', 'tran_id','bank_tran_id','card_issuer','currency','amount'));
            } else {
                /*
    ...
    public function cancel(Request $request)
    {
        ...
        if ($order_detials->status == 'Pending') {
            ...
            return view('pages.payment.cancel', compact('msg','tran_id','amount','currency'));
        } else if ($order_detials->status == 'Processing' || $order_detials->status == 'Complete') {
            echo "Transaction is already Successful";
        } else {
            echo "Transaction is Invalid";
